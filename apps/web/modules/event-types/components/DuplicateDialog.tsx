...
const DuplicateDialog = () => {
  ...
  useEffect(() => {
    if (searchParams?.get("dialog") === "duplicate") {
      ...
      form.setValue(
        "slug",
        t("event_type_duplicate_copy_text", {
  ...
  const duplicateMutation = trpc.viewer.eventTypesHeavy.duplicate.useMutation({
    onSuccess: async ({ eventType }) => {
      if (typeof pendo !== "undefined") {
        pendo.track("event_type_duplicated", {
          new_event_type_id: eventType.id,
          ...
          <div className="-mt-2 stack-y-5">
            ...
            <Editor
              ...
              setText={(value: string) =>
                form.setValue("description", turndown(value))
              }
